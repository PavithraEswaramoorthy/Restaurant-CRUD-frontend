    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', marginBottom: '10px', marginTop:"50px" }}>
                <TextField id="todo" label="Order Items" variant="outlined" value={todo} onChange={(e) => setTodo(e.target.value)} />

                <Button variant="outlined" onClick={create} style={{ marginLeft: '10px' }}>Order</Button>
